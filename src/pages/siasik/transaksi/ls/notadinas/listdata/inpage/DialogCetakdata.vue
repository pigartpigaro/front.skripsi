              ...
              <q-card-section class="q-py-sm q-px-md full-width">
                <table class="float-center full-width bordered">
                  ...
                  <tbody class="align-middle q-pl-sm">
                    <tr v-for="item in store.cetaknotadinas.rincians" :key="item">
                      <td>
                        <div>{{ item.nonpdls }}</div>
                      </td>
                      <td>
                        <div>{{ item.tglnpdls }}</div>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td class="text-right text-bold">
                        <div class="row full-width justify-between">
                          <div class="col-auto flex-start">Rp. </div>
                          <div class="flex-end text-right">{{ formattanpaRp(store.cetaknotadinas.total) }}</div>
                        </div>
                      </td>
                    </tr>
                  </tbody>
                ...
                <div class="col-auto q-pt-sm text-bold">
                  <div class="row q-col-gutter-md full-width">
                    ...
                    <div class="col full-width">
                      ...
                      <div>: {{ terbilangRupiah(store.cetaknotadinas.total) + ' Rupiah' }} </div>
                    </div>
                  </div>
                </div>
                <div class="row q-pr-md q-pt-sm full-width">
                  <div class="col q-px-sm text-justify text-wrap">
                    Demikian untuk menjadikan periksa dan persetujuan lebih lanjut
                  </div>
                </div>
              </q-card-section>
