...
import { usePasienKonsulanStore } from 'src/stores/simrs/pendaftaran/kunjungan/bpjs/konsulan'
import HeaderComp from './comp/HeaderComp.vue'
import ListKonsulan from './comp/ListKonsulan.vue'
import BottomComp from './comp/BottomComp.vue'

const style = useStyledStore()
const store = usePasienKonsulanStore()
