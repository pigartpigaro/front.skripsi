  ...
  >
    <div class="col-auto ">
      <PageHead
        ...
        title="Master SPRI"
        subtitle="Pengaturan Master SPRI RAWAT INAP"
      />
    </div>
    <q-card
      flat
    ...
    >
      ...
      >
        ...
        <master-spri :editable-master="true" />
      </q-scroll-area>
    </q-card>
  </q-page>
</template>
...
const MasterSpri = defineAsyncComponent(() => import('src/components/callComponents/MasterSpri.vue'))
