...
const title = computed(() => {
  if (page.path === '/kasir/rajal/listkunjungan') {
    return 'LIST KUNJUNGAN PASIEN UMUM'
  } else if (page.path === '/kasir/rajal/billing') {
    return 'BILLING PASIEN'
  } else {
...
const subtitle = computed(() => {
  if (page.path === '/kasir/rajal/listkunjungan') {
    return 'List Kunjungan Pasien'
  } else if (page.path === '/kasir/rajal/billing') {
    return 'Billing Pasien'
  } else {
    return 'Halaman Billing pasien'
  }
})
onMounted(() => {
