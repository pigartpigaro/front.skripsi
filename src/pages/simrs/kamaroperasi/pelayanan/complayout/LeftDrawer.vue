    ...
    <div class="absolute-bottom">
      ...
      >
        ...
        <div class="text-weight-bold f-12 q-mt-sm">
          {{ pasien?.kunjunganranap?.masterpasien?.rs2 ?? pasien?.kunjunganrajal?.masterpasien?.rs2 }}
        </div>
        ...
        <div class="text-yellow text-italic f-10">
          {{ pasien?.usia?? '-' }} Tahun || {{ pasien?.kunjunganranap?.masterpasien?.rs17 ?? pasien?.kunjunganrajal?.masterpasien?.kelamin }}
        </div>
      </div>
      <q-bar>
        <q-space />
