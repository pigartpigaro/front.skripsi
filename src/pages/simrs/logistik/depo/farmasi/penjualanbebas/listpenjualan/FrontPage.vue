...
// const page = useRoute()
onMounted(() => {
  console.log('height default', pageRef.value.$el.clientHeight)
  h.value = pageRef.value.$el.clientHeight > 0 ? pageRef.value.$el.clientHeight - 40 : 500
  console.log('height ', h.value)
})
