            ...
            >
              <q-item-label>
                <div
                  class="ellipsis row"
                >
                  <div v-if="labelFront(item)!=='' && !!scope.opt[item]">
                    {{ labelFront(item) }} :
                  </div>
                  <div :class="labelFront(item)!==''?'q-ml-sm':''">
                    {{ scope.opt[item] }}
                  </div>
                </div>
              </q-item-label>
...
function labelFront (val) {
  let temp = ''
  if (val === 'namaobat') temp = ''
  else if (val === 'total') temp = 'stok'
  else if (val === 'kanduangan') temp = 'kandungan'
  else temp = ''
  return temp
}
function fetchData () {
