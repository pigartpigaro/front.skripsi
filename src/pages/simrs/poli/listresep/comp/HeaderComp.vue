...
const emits = defineEmits(['cari', 'refresh', 'setPerPage', 'setFlag', 'setPeriode', 'cariDokter'])
const props = defineProps({
  search: { type: String, default: '' },
  dokter: { type: String, default: '' },
...
const gtdokter = computed({
  get () {
    return props.dokter
  },
  set (newVal) {
    emits('cariDokter', newVal)
  }
})
// flag
