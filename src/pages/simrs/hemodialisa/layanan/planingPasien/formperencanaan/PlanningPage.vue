...
const comp = [
  ...
  { nama: 'Kontrol', page: defineAsyncComponent(() => import('./FormKontrol.vue')) },
  // { nama: 'Puskesmas', page: defineAsyncComponent(() => import('./formperencanaan/FormPuskesmas.vue')) },
  { nama: 'RawatInap', page: defineAsyncComponent(() => import('./FormRawatInap.vue')) },
  { nama: 'RumahSakitLain', page: defineAsyncComponent(() => import('./FormRumahSakitLain.vue')) },
  ...
  // { nama: 'Pulang', page: defineAsyncComponent(() => import('./formperencanaan/FormPulang.vue')) }
]
const cekPanel = () => {
