...
import useEws from 'src/pages/simrs/hemodialisa/layanan/Ews/useEws'
import { useAplikasiStore } from 'src/stores/app/aplikasi'
import { usePemeriksaanUmumHemodialisaStore } from 'src/stores/simrs/hemodialisa/pemeriksaanumum'

const AutocompleteInput = defineAsyncComponent(() => import('src/pages/simrs/hemodialisa/layanan/components/AutocompleteInput.vue'))
const SelectInput = defineAsyncComponent(() => import('src/pages/simrs/hemodialisa/layanan/components/SelectInput.vue'))
