...
export const usePenilaianHemodialisaStore = defineStore('penilaian-hemodialisa-store', {
  state: () => ({
    usia: 0,
    items: {
      ranap: [],
  ...
  actions: {
    ...
    async getData (pasien) {
      ...
      const resp = await api.get('v1/simrs/hemodialisa/layanan/pemeriksaan/penilaian', params)
    ...
    async saveData (jnsKasus, pasien) {
      ...
      try {
        const resp = await api.post('v1/simrs/hemodialisa/layanan/pemeriksaan/penilaian/simpan', frm)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(usePenilaianHemodialisaStore, import.meta.hot))
}
