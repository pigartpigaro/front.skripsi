...
export const useAnatommyHemodialisaStore = defineStore('anatomy-hemodialisa-store', {
  state: () => ({
    form: {
      // prognosis: null,
      // caraKeluar: null
  ...
  actions: {
    ...
    async getmasteranatomys () {
      const resp = await api.get('v1/simrs/hemodialisa/layanan/pemeriksaan/getmasteranatomys')
