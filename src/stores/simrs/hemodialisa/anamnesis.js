...
export const useAnamnesisHemodialisaStore = defineStore('anamnesis-hemodialisa-store', {
  state: () => ({
  ...
  actions: {
    ...
    async getData (pasien) {
      ...
      try {
        const resp = await api.get('v1/simrs/hemodialisa/layanan/anamnesis/list', params)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useAnamnesisHemodialisaStore, import.meta.hot))
}
