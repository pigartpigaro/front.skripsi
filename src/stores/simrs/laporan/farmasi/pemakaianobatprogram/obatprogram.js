...
export const useLaporanPermakaianObatProgramStore = defineStore('laporan_pemakaian_obat_program', {
  state: () => ({
    loading: false,
    loadingNext: false,
    scrolling: false,
  ...
  actions: {
        ...
        Dialog.create({
          ...
          .onOk(async () => {
            ...
            do {
              ...
              const resp = await api.get('v1/simrs/laporan/farmasi/pemakaian/get-pemakaian-program', param)
    ...
    getDatanya (items) {
      ...
      return new Promise(resolve => {
        api.get('v1/simrs/laporan/farmasi/pemakaian/get-pemakaian-program', param)
          .then(resp => {
    ...
    async getDataTable (val) {
      ...
      this.scrolling = true
      const param = { params: this.params }
      await api.get('v1/simrs/laporan/farmasi/pemakaian/get-pemakaian-program', param)
        .then(resp => {
